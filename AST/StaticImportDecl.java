 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/StaticImports.ast:4
 */
public abstract class StaticImportDecl extends ImportDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect Uses
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/Uses.jrag:113
   */
  public abstract SimpleSet importedFields();
  /**
   * @ast method 
   * 
   */
   ...
   * @aspect StaticImports
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/StaticImports.jrag:21
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect StaticImports
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/StaticImports.jrag:31
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect StaticImports
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/StaticImports.jrag:42
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute coll
   * @aspect Uses
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/Uses.jrag:110
   */
    for(java.util.Iterator iter = (importedFields()).iterator(); iter.hasNext(); ) {
      FieldDeclaration ref = (FieldDeclaration)iter.next();
      if(ref != null)
      ref.FieldDeclaration_staticImports_contributors().add(this);
    }
  ...
  protected void contributeTo_FieldDeclaration_FieldDeclaration_staticImports(Collection<StaticImportDecl> collection) {
    super.contributeTo_FieldDeclaration_FieldDeclaration_staticImports(collection);
    collection.add(this);
  }
