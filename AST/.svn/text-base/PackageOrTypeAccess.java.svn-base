 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:34
 */
public class PackageOrTypeAccess extends Access implements Cloneable {
   ...
   * @ast method 
   * @aspect NameCheck
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/NameCheck.jrag:60
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/NodeConstructors.jrag:28
   */
   ...
   * 
   */
  public void refined__PackageOrTypeAccess_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:399
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__PackageOrTypeAccess_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__PackageOrTypeAccess_setID(value);
				}
			});
		}
		refined__PackageOrTypeAccess_setID(value);
   ...
   * @attribute syn
   * @aspect Names
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/QualifiedNames.jrag:15
   */
  public String name() {
    ASTNode$State state = state();
    try {  return getID();  }
  ...
  public ASTNode rewriteTo() {
    // Declared in /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/ResolveAmbiguousNames.jrag at line 175
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/ResolveAmbiguousNames.jrag:175
   * @apilevel internal
