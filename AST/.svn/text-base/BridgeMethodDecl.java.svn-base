 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:51
 */
public class BridgeMethodDecl extends MethodDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect MethodExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/MethodExt.jrag:327
   */
   ...
   * 
   */
  public void refined__BridgeMethodDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1301
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__BridgeMethodDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__BridgeMethodDecl_setID(value);
				}
			});
		}
		refined__BridgeMethodDecl_setID(value);
