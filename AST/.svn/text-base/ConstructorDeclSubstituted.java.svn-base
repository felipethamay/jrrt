 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:31
 */
public class ConstructorDeclSubstituted extends ConstructorDecl implements Cloneable {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/ConstructorExt.jrag:110
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/IntroduceFactory/IntroduceFactory.jrag:23
   */
   ...
   * 
   */
  public void refined__ConstructorDeclSubstituted_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:949
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ConstructorDeclSubstituted_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ConstructorDeclSubstituted_setID(value);
				}
			});
		}
		refined__ConstructorDeclSubstituted_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1517
   */
  @SuppressWarnings({"unchecked", "cast"})
