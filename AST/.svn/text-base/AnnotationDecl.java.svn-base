 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.ast:2
 */
public class AnnotationDecl extends InterfaceDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:103
   */
   ...
   * @ast method 
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:562
   */
   ...
   * 
   */
  public void refined__AnnotationDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:751
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__AnnotationDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__AnnotationDecl_setID(value);
				}
			});
		}
		refined__AnnotationDecl_setID(value);
   ...
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:99
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:144
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:77
   * @apilevel internal
   */
