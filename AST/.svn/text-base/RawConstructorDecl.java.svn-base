 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.ast:11
 */
public class RawConstructorDecl extends ParConstructorDecl implements Cloneable {
   ...
   * 
   */
  public void refined__RawConstructorDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:927
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__RawConstructorDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__RawConstructorDecl_setID(value);
				}
			});
		}
		refined__RawConstructorDecl_setID(value);
  ...
  public ConstructorDecl refreshConstructor() {
    ASTNode$State state = state();
    try {  return ((GenericConstructorDecl)((ConstructorDecl)getParent().getParent()).refresh()).rawConstructor();  }
    finally {
    }
  }
  /**
