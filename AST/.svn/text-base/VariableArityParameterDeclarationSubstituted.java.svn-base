 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:34
 */
public class VariableArityParameterDeclarationSubstituted extends VariableArityParameterDeclaration implements Cloneable {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/Naming/LockedVariableAccess.jrag:61
   */
   ...
   * 
   */
  public void refined__VariableArityParameterDeclarationSubstituted_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1125
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__VariableArityParameterDeclarationSubstituted_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__VariableArityParameterDeclarationSubstituted_setID(value);
				}
			});
		}
		refined__VariableArityParameterDeclarationSubstituted_setID(value);
