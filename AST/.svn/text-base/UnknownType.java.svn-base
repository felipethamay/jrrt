 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:50
 */
public class UnknownType extends ClassDecl implements Cloneable {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/Naming/LockedTypeAccess.jrag:8
   */
  public boolean hasName() { return false; }
  /**
   * @ast method 
   * @aspect MakeTypeAbstract
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/PushDown/MakeTypeAbstract.jrag:6
   */
   ...
   * 
   */
  public void refined__UnknownType_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:619
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__UnknownType_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__UnknownType_setID(value);
				}
			});
		}
		refined__UnknownType_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:393
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:414
   */
  @SuppressWarnings({"unchecked", "cast"})
