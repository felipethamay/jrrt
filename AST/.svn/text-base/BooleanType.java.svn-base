 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:54
 */
public class BooleanType extends PrimitiveType implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/PrettyPrint.jadd:832
   */
   ...
   * @attribute syn
   * @aspect AutoBoxing
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/AutoBoxing.jrag:36
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public Expr defaultValue() {
    ASTNode$State state = state();
    try {  return new BooleanLiteral(false);  }
    finally {
    }
  }
  /**
