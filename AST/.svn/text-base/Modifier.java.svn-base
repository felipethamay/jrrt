 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:191
 */
public class Modifier extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/PrettyPrint.jadd:442
   */
   ...
   * 
   */
  public void refined__Modifier_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1345
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__Modifier_setID(oldValue);
				}
				@Override
   ...
   * @attribute syn
   * @aspect Visibility
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/Visibility.jrag:52
   */
  public boolean isVisibility() {
    ASTNode$State state = state();
    try {  return getID().equals("public") || getID().equals("protected") || getID().equals("private");  }
    finally {
    }
  }
  /**
