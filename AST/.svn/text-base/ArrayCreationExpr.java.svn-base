 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:133
 */
public class ArrayCreationExpr extends PrimaryExpr implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/PrettyPrint.jadd:356
   */
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/DefiniteAssignment.jrag:432
   */
   ...
   * @attribute syn
   * @aspect DU
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/DefiniteAssignment.jrag:860
   */
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:312
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public CFGNode first() {
    ASTNode$State state = state();
    try {  return getTypeAccess().first();  }
    finally {
    }
  }
  /**
  ...
  public boolean isFlowInvariant() {
    ASTNode$State state = state();
    try {  return getTypeAccess().isFlowInvariant() && (!hasArrayInit() || getArrayInit().isFlowInvariant());  }
    finally {
    }
  }
  /**
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/DefiniteAssignment.jrag:434
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/DefiniteAssignment.jrag:863
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/SyntacticClassification.jrag:87
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:262
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/ControlFlowGraph/ControlFlowGraph.jrag:311
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/ExprExt.jrag:41
   * @apilevel internal
   */
