 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.ast:3
 */
public class AnnotationMethodDecl extends MethodDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:160
   */
   ...
   * @ast method 
   * @aspect Annotations
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Annotations.jrag:571
   */
   ...
   * @ast method 
   * @aspect MethodExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/MethodExt.jrag:326
   */
  public MethodDecl lockedCopyWithEmptyBody() { throw new UnsupportedOperationException(); }
  /**
   * @ast method 
   * 
   */
   ...
   * 
   */
  public void refined__AnnotationMethodDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1257
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__AnnotationMethodDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__AnnotationMethodDecl_setID(value);
				}
			});
		}
		refined__AnnotationMethodDecl_setID(value);
