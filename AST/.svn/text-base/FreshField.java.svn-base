...
/**
 * @production FreshField : {@link FieldDeclaration};
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/LanguageExtensions/FreshVariables.ast:3
 */
public class FreshField extends FieldDeclaration implements Cloneable, FreshVariable {
  ...
  public FreshField clone() throws CloneNotSupportedException {
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public FreshField fullCopy() {
    FreshField tree = (FreshField) copy();
    if (children != null) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/LanguageExtensions/FreshVariables.jrag:66
   */
   ...
   * @ast method 
   * @aspect FreshVariables
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/LanguageExtensions/FreshVariables.jrag:77
   */
   ...
   * 
   */
  public void refined__FreshField_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1015
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__FreshField_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__FreshField_setID(value);
				}
			});
		}
		refined__FreshField_setID(value);
