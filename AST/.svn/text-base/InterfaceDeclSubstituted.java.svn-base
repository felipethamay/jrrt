 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:42
 */
public class InterfaceDeclSubstituted extends InterfaceDecl implements Cloneable, MemberSubstitutor, TypeDeclSubstituted {
  /**
   * @apilevel low-level
   */
   ...
   * 
   */
  public void refined__InterfaceDeclSubstituted_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:817
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__InterfaceDeclSubstituted_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__InterfaceDeclSubstituted_setID(value);
				}
			});
		}
		refined__InterfaceDeclSubstituted_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1051
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1507
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:487
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:501
   */
  @SuppressWarnings({"unchecked", "cast"})
