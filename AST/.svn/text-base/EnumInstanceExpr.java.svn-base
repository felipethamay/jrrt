 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Enums.ast:5
 */
public class EnumInstanceExpr extends ClassInstanceExpr implements Cloneable {
  ...
  * @attribute syn nta
   * @aspect Enums
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Enums.jrag:209
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect Enums
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Enums.jrag:213
   */
  @SuppressWarnings({"unchecked", "cast"})
