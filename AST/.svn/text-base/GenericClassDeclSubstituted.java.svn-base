 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:43
 */
public class GenericClassDeclSubstituted extends GenericClassDecl implements Cloneable, MemberSubstitutor, TypeDeclSubstituted {
  /**
   * @apilevel low-level
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/PushDown/MakeTypeAbstract.jrag:10
   */
   ...
   * 
   */
  public void refined__GenericClassDeclSubstituted_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1455
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__GenericClassDeclSubstituted_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__GenericClassDeclSubstituted_setID(value);
				}
			});
		}
		refined__GenericClassDeclSubstituted_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1052
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1508
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:488
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:511
   */
  @SuppressWarnings({"unchecked", "cast"})
