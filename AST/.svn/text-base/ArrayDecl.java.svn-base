 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:68
 */
public class ArrayDecl extends ClassDecl implements Cloneable {
  ...
  public void flushCache() {
    ...
    getElementLocation_computed = false;
    getElementLocation_value = null;
  ...
  public ArrayDecl clone() throws CloneNotSupportedException {
    ...
    node.getElementLocation_computed = false;
    node.getElementLocation_value = null;
   ...
   * @ast method 
   * @aspect Arrays
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/Arrays.jrag:59
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:880
   */
   ...
   * @ast method 
   * @aspect LookupParTypeDecl
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:916
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/Naming/LockedTypeAccess.jrag:40
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/PushDown/MakeTypeAbstract.jrag:4
   */
  public void makeAbstract() { throw new RefactoringException("array type cannot be made abstract"); }
  /**
   * @ast method 
   * 
   */
   ...
   * 
   */
  public void refined__ArrayDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:641
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ArrayDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ArrayDecl_setID(value);
				}
			});
		}
		refined__ArrayDecl_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:120
   */
  private boolean refined_TypeConversion_ArrayDecl_castingConversionTo_TypeDecl(TypeDecl type)
{
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AccessControl.jrag:13
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Arrays
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/Arrays.jrag:12
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Arrays
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/Arrays.jrag:16
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Arrays
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/Arrays.jrag:54
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect TypeName
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/QualifiedNames.jrag:87
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:96
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:389
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethodsInference.jrag:17
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:353
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1082
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect GenericsSubtype
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericsSubtype.jrag:409
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @apilevel internal
   */
  protected boolean getElementLocation_computed = false;
  /**
   * @apilevel internal
   */
  protected ArrayElementLocation getElementLocation_value;
  /**
   * @attribute syn
   * @aspect Alias
   * @declaredat /Users/melmongiovi/Documents/workspace6/ControlFlowGraph/Alias.jrag:41
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ArrayElementLocation getElementLocation() {
    if(getElementLocation_computed) {
      return getElementLocation_value;
    }
    ASTNode$State state = state();
  int num = state.boundariesCrossed;
  boolean isFinal = this.is$Final();
    getElementLocation_value = getElementLocation_compute();
      if(isFinal && num == state().boundariesCrossed) getElementLocation_computed = true;
    return getElementLocation_value;
  }
  /**
   * @apilevel internal
   */
  private ArrayElementLocation getElementLocation_compute() {  return new ArrayElementLocation(componentType());  }
  /**
   * @attribute syn
   * @aspect Refresh
  ...
  public TypeDecl refreshType() {
    ASTNode$State state = state();
    try {  return componentType().refresh().arrayType();  }
    finally {
    }
  }
   ...
   * @attribute syn
   * @aspect Alpha
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/AccessibilityConstraints/Alpha.jrag:21
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @apilevel internal
   */
  private int minAccess_compute(String pkg, TypeDecl type) {  return elementType().minAccess(pkg, type);  }
  /*
   ...
   * @attribute inh
   * @aspect TypeConversion
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:140
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect TypeConversion
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:141
   */
  @SuppressWarnings({"unchecked", "cast"})
