 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:70
 */
public class AnonymousDecl extends ClassDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect TypeExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/TypeExt.jrag:13
   */
  public ClassDecl asNamedClass(String name, int visibility) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/Naming/LockedTypeAccess.jrag:7
   */
  public boolean hasName() { return false; }
  /**
   * @ast method 
   * @aspect MakeTypeAbstract
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/PushDown/MakeTypeAbstract.jrag:3
   */
  public void makeAbstract() { throw new RefactoringException("anonymous type cannot be made abstract"); }
  /**
   * @ast method 
   * @aspect AnonymousClassToLocalClass
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/TypePromotion/AnonymousClassToLocalClass.jrag:2
   */
  public LocalClassDeclStmt promoteToLocalClass(String name, boolean makeFinal) {
		Stmt stmt;
   ...
   * @ast method 
   * @aspect AnonymousClassToLocalClass
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/TypePromotion/AnonymousClassToLocalClass.jrag:27
   */
  public LocalClassDeclStmt doPromoteToLocalClass(String name, boolean makeFinal) {
   ...
   * @ast method 
   * @aspect AnonymousClassToLocalClass
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/TypePromotion/AnonymousClassToLocalClass.jrag:34
   */
  public LocalClassDeclStmt doPromoteToLocalClass(String name) {
		return doPromoteToLocalClass(name, true);
	}
  /**
   * @ast method 
   * @aspect AnonymousClassToMemberClass
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/TypePromotion/AnonymousClassToMemberClass.jrag:2
   */
  public MemberTypeDecl doPromoteToMemberClass(String className, boolean makeFinal, boolean makePublic) {
   ...
   * 
   */
  public void refined__AnonymousDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/VariableArityParameters.jrag:107
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:839
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__AnonymousDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__AnonymousDecl_setID(value);
				}
			});
		}
		refined__AnonymousDecl_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:30
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect AnonymousClasses
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:32
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect AnonymousClasses
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:38
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:14
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:18
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:175
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public ASTNode rewriteTo() {
    // Declared in /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag at line 70
    if(noConstructor()) {
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/AnonymousClasses.jrag:70
   * @apilevel internal
