 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.ast:2
 */
public class GenericMethodDecl extends MethodDecl implements Cloneable, GenericElement {
  /**
   * @apilevel low-level
   */
  public void flushCache() {
    ...
    lookupParMethodDecl_java_util_List_list = null;    GenericMethodDecl_parUses_computed = false;
    GenericMethodDecl_parUses_value = null;
    GenericMethodDecl_parUses_contributors = null;
  }
  /**
   * @apilevel internal
   */
  public void flushCollectionCache() {
    ...
    GenericMethodDecl_parUses_computed = false;
    GenericMethodDecl_parUses_value = null;
    GenericMethodDecl_parUses_contributors = null;
  }
  /**
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:103
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:225
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1261
   */
   ...
   * @ast method 
   * @aspect LookupParTypeDecl
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1277
   */
   ...
   * @ast method 
   * @aspect MethodExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/MethodExt.jrag:106
   */
   ...
   * @ast method 
   * @aspect MethodExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/MethodExt.jrag:306
   */
   ...
   * @ast method 
   * @aspect MethodExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/MethodExt.jrag:372
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/MakeMethodStatic/MakeMethodStatic.jrag:62
   */
   ...
   * 
   */
  public void refined__GenericMethodDecl_setID(String value) {
   ...
   * @ast method 
   * @aspect Testing
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/tests/Testing.jrag:139
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:1191
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__GenericMethodDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__GenericMethodDecl_setID(value);
				}
			});
		}
		refined__GenericMethodDecl_setID(value);
   ...
   * @attribute syn
   * @aspect GenericMethods
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:34
   */
  @SuppressWarnings({"unchecked", "cast"})
...
* @attribute syn
   * @aspect GenericMethods
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:74
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:147
   */
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1276
   */
  public GenericMethodDecl original() {
    ASTNode$State state = state();
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/LanguageExtensions/AnonymousMethods.jrag:220
   */
   ...
   * @attribute inh
   * @aspect GenericMethodsNameAnalysis
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:146
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:144
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:154
   * @apilevel internal
   */
   ...
   * @apilevel internal
   */
  protected boolean GenericMethodDecl_parUses_computed = false;
  /**
   * @apilevel internal
   */
  protected Collection<MethodAccess> GenericMethodDecl_parUses_value;
  /**
   * @attribute coll
   * @aspect MethodExt
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public Collection<MethodAccess> parUses() {
    if(GenericMethodDecl_parUses_computed) {
      return GenericMethodDecl_parUses_value;
    }
    ASTNode$State state = state();
  int num = state.boundariesCrossed;
  boolean isFinal = this.is$Final();
    GenericMethodDecl_parUses_value = parUses_compute();
      if(isFinal && num == state().boundariesCrossed) GenericMethodDecl_parUses_computed = true;
    return GenericMethodDecl_parUses_value;
  }
  java.util.Set GenericMethodDecl_parUses_contributors;
  public java.util.Set GenericMethodDecl_parUses_contributors() {
    if(GenericMethodDecl_parUses_contributors == null) GenericMethodDecl_parUses_contributors  = new ASTNode$State.IdentityHashSet(4);
    return GenericMethodDecl_parUses_contributors;
  }
  /**
   * @apilevel internal
   */
  private Collection<MethodAccess> parUses_compute() {
    ASTNode node = this;
    while(node.getParent() != null && !(node instanceof Program))
      node = node.getParent();
    Program root = (Program)node;
    root.collect_contributors_GenericMethodDecl_parUses();
    GenericMethodDecl_parUses_value = new HashSet<MethodAccess>();
    if(GenericMethodDecl_parUses_contributors != null)
    for(java.util.Iterator iter = GenericMethodDecl_parUses_contributors.iterator(); iter.hasNext(); ) {
      ASTNode contributor = (ASTNode)iter.next();
      contributor.contributeTo_GenericMethodDecl_GenericMethodDecl_parUses(GenericMethodDecl_parUses_value);
    }
    return GenericMethodDecl_parUses_value;
  }
