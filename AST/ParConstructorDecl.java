 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.ast:10
 */
public class ParConstructorDecl extends ConstructorDecl implements Cloneable {
  ...
  public void flushCache() {
    ...
    sameSignature_ArrayList_TypeDecl__values = null;
  }
  /**
   * @apilevel internal
   */
  ...
  public ParConstructorDecl clone() throws CloneNotSupportedException {
    ...
    node.sameSignature_ArrayList_TypeDecl__values = null;
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/ConstructorExt.jrag:113
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/IntroduceFactory/IntroduceFactory.jrag:27
   */
   ...
   * 
   */
  public void refined__ParConstructorDecl_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:905
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ParConstructorDecl_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ParConstructorDecl_setID(value);
				}
			});
		}
		refined__ParConstructorDecl_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:49
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:1516
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  protected java.util.Map sameSignature_ArrayList_TypeDecl__values;
  /**
   * @attribute syn
   * @aspect ConstructorExt
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/util/ConstructorExt.jrag:19
   */
  @SuppressWarnings({"unchecked", "cast"})
  public boolean sameSignature(ArrayList<TypeDecl> list) {
    Object _parameters = list;
    if(sameSignature_ArrayList_TypeDecl__values == null) sameSignature_ArrayList_TypeDecl__values = new java.util.HashMap(4);
    ASTNode$State.CircularValue _value;
    if(sameSignature_ArrayList_TypeDecl__values.containsKey(_parameters)) {
      Object _o = sameSignature_ArrayList_TypeDecl__values.get(_parameters);
      ...
      sameSignature_ArrayList_TypeDecl__values.put(_parameters, _value);
    ...
    if (!state.IN_CIRCLE) {
      ...
      int num = state.boundariesCrossed;
      boolean isFinal = this.is$Final();
      boolean new_sameSignature_ArrayList_TypeDecl__value;
      do {
        _value.visited = new Integer(state.CIRCLE_INDEX);
        state.CHANGE = false;
        new_sameSignature_ArrayList_TypeDecl__value = sameSignature_compute(list);
        if (new_sameSignature_ArrayList_TypeDecl__value!=((Boolean)_value.value).booleanValue()) {
          state.CHANGE = true;
          _value.value = Boolean.valueOf(new_sameSignature_ArrayList_TypeDecl__value);
        }
        state.CIRCLE_INDEX++;
      } while (state.CHANGE);
        if(isFinal && num == state().boundariesCrossed) {
        sameSignature_ArrayList_TypeDecl__values.put(_parameters, new_sameSignature_ArrayList_TypeDecl__value);
      }
      else {
        sameSignature_ArrayList_TypeDecl__values.remove(_parameters);
      state.RESET_CYCLE = true;
      sameSignature_compute(list);
      state.RESET_CYCLE = false;
      }
      state.IN_CIRCLE = false; 
      return new_sameSignature_ArrayList_TypeDecl__value;
    }
    if(!new Integer(state.CIRCLE_INDEX).equals(_value.visited)) {
      _value.visited = new Integer(state.CIRCLE_INDEX);
      boolean new_sameSignature_ArrayList_TypeDecl__value = sameSignature_compute(list);
      if (state.RESET_CYCLE) {
        sameSignature_ArrayList_TypeDecl__values.remove(_parameters);
      }
      else if (new_sameSignature_ArrayList_TypeDecl__value!=((Boolean)_value.value).booleanValue()) {
        state.CHANGE = true;
        _value.value = new_sameSignature_ArrayList_TypeDecl__value;
      }
      return new_sameSignature_ArrayList_TypeDecl__value;
    }
   ...
   * @apilevel internal
   */
  private boolean sameSignature_compute(ArrayList<TypeDecl> list) {
