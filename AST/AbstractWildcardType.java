 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.ast:25
 */
public abstract class AbstractWildcardType extends TypeDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect Generics
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/Generics.jrag:17
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/Naming/LockedTypeAccess.jrag:4
   */
   ...
   * 
   */
  public void refined__AbstractWildcardType_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:531
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__AbstractWildcardType_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__AbstractWildcardType_setID(value);
				}
			});
		}
		refined__AbstractWildcardType_setID(value);
