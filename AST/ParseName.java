 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/java.ast:33
 */
public class ParseName extends Access implements Cloneable {
   ...
   * 
   */
  public void refined__ParseName_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:377
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ParseName_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ParseName_setID(value);
				}
			});
		}
		refined__ParseName_setID(value);
   ...
   * @attribute syn
   * @aspect Names
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/QualifiedNames.jrag:14
   */
  public String name() {
    ASTNode$State state = state();
    try {  return getID();  }
  ...
  public ASTNode rewriteTo() {
    // Declared in /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/SyntacticClassification.jrag at line 15
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/SyntacticClassification.jrag:15
   * @apilevel internal
