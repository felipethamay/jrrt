...
public class UtilTests extends TestCase {
	...
	public void testSupertypestransitive() {
		Program p = Program.fromClasses("interface I {}",
				"interface J extends I {}", "class A implements I {}",
				"class B extends A implements J {}",
				"class C extends B implements J {}");
		Collection<TypeDecl> supertypesC = p.findType("C")
		...
		Collection<TypeDecl> supertypesA = p.findType("A")
				.supertypestransitive();
		...
		Collection<TypeDecl> supertypesJ = p.findType("J")
				.supertypestransitive();
