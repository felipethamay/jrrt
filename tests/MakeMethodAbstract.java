...
public class MakeMethodAbstract extends TestCase {
	...
	public void test1() {
		testSucc("A", "m()", Program.fromClasses("public class A {"
				+ "    public void m() { }" + "    public void n() { m(); }"
				+ "}"), Program.fromClasses("abstract public class A {"
	...
	public void test2() {
		testSucc("A", "m()", Program.fromClasses("public class A {"
				...
				+ "}", "public class C extends A {" + "    public void m() { }"
				+ "}"), Program.fromClasses("abstract public class A {"
				+ "    abstract public void m();"
				+ "    public void n() { m(); }" + "}",
				"public class B extends A {" + "    public void m() { }" + "}",
	...
	public void test3() {
		testSucc("A", "m()", Program.fromCompilationUnits(new RawCU("A.java",
				"package p;" + "public class A {" + "  void m() { }"
						+ "  void n() { m(); }" + "}"), new RawCU("B.java",
				"package q;" + "public class B extends p.A {"
						+ "  void m() { }" + "}")),
				Program.fromCompilationUnits(new RawCU("A.java", "package p;"
						+ "abstract public class A {" + "  abstract void m();"
						+ "  void n() { m(); }" + "}"), new RawCU("B.java",
						"package q;" + "abstract public class B extends p.A {"
								+ "  void m() { }" + "}")));
	}
	...
	public void test5() {
		testSucc("A", "m()", Program.fromCompilationUnits(new RawCU("A.java",
				"package p;" + "public class A {" + "  void m() { }"
						+ "  void n() { m(); }" + "}"), new RawCU("B.java",
				"package q;" + "public class B extends p.A {"
						+ "  void m() { }" + "}"), new RawCU("C.java",
				"package p;" + "public class C extends q.B {"
						+ "  void m() { }" + "}")),
				Program.fromCompilationUnits(new RawCU("A.java", "package p;"
						+ "abstract public class A {" + "  abstract void m();"
						+ "  void n() { m(); }" + "}"), new RawCU("B.java",
	...
	public void test6() {
		testFail("A", "m()", Program.fromClasses("public class A {"
				+ "    public void m() { }" + "}", "public class B extends A {"
