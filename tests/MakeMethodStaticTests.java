...
public class MakeMethodStaticTests extends TestCase {
	...
	public void test1() {
		testSucc("A", "m()", Program.fromClasses("class A {"
				+ "    public void m() { }" + "}"),
	...
	public void test2() {
		testSucc("A", "m()", Program.fromClasses("class A {"
				+ "    static int i;" + "    public int m() { return i; }"
				+ "}"), Program.fromClasses("class A {" + "    static int i;"
				+ "    public int m() { return m(this); }"
				+ "    public static int m(A a) {	return i; }" + "}"));
	}

	public void test3() {
		testSucc("A", "m()", Program.fromClasses("class A {" + "    int i;"
				+ "    public int m() { return i; }" + "}"),
				Program.fromClasses("class A {" + "    int i;"
						+ "    public int m() { return m(this); }"
	...
	public void test4() {
		testSucc("A", "m()", Program.fromClasses("class A {"
				+ "    public int i;" + "    public int m() { return this.i; }"
				+ "}"), Program.fromClasses("class A {" + "    public int i;"
				+ "    public int m() { return m(this); }"
				+ "    public static int m(A a) { return a.i; }" + "}"));
	}
	...
	public void test5() {
		testSucc(
				"A",
				"m()",
				Program.fromClasses("class Super { public int i; }",
						"class A extends Super {" + "    public int i;"
	...
	public void test8() {
		testSucc("A", "m(int)", Program.fromClasses("class A {"
				+ "    public int myData;" + "    int m(int i) {"
				+ "        new Runnable () {" + "            void f(int i) {};"
				+ "            public void run() {"
				+ "                this.f(myData);" + "            }"
	...
	public void test9() {
		testSucc("A", "m(int)", Program.fromClasses("class A {"
				...
				"class B extends A {" + "    int a(int b) { return m(b*2); }"
						+ "}"), Program.fromClasses("class A {"
				+ "    public int myData;"
				+ "    int m(int i) { return m(this, i); }"
	...
	public void test10() {
		testSucc("A", "m(int)", Program.fromClasses("class A {"
				+ "    public int myData;"
				+ "    int m(int i) { return myData+i; }" + "}", "class B {"
				+ "    public A myA;"
				+ "    int a(int b) { return myA.m(b*2); }" + "}"),
				Program.fromClasses("class A {" + "    public int myData;"
						+ "    int m(int i) { return m(this, i); }"
						+ "    static int m(A a, int i) { return a.myData+i; }"
	...
	public void test12() {
		testFail("A", "m()",
				Program.fromClasses("class A extends java.util.Vector {"
	...
	public void test14() {
		testSucc("A", "m()", Program.fromClasses("class A {" + "   A m() {"
				+ "     final A[] result = new A[1];" + "     new Runnable() {"
				+ "         public void run() {"
				+ "            result[0] = A.this;" + "         }"
				+ "     }.run();" + "     return result[0];" + "   }" + "}"),
				Program.fromClasses("class A {"
	...
	public void test15() {
		testSucc("A", "m(boolean)", Program.fromClasses("class A {"
				+ "  A f() { return this; }" + "  void m(boolean b) {"
				+ "    if(b) f().m(!b);" + "  }" + "}"),
				Program.fromClasses("class A {" + "  A f() { return this; }"
	...
	public void test16() {
		testSucc("A", "m()", Program.fromClasses("class A {"
				+ "    void f(String s) {}" + "    String field;"
				+ "    void m() {" + "        f(field);" + "    }" + "}"),
				Program.fromClasses("class A {" + "    void f(String s) {}"
						+ "    String field;" + "    void m() { m(this); }"
						+ "    static void m(A a) {" + "      a.f(a.field);"
						+ "    }" + "}"));
	}

	public void test18() {
		testSucc("A", "m()", Program.fromClasses("class A<T> {"
				+ "    void m() { System.out.println(this); }" + "}"),
				Program.fromClasses("class A<T> {"
						+ "    void m() { m(this); }"
	...
	public void test19() {
		testSucc("A", "m(int)", Program.fromClasses("class A {"
				+ "    int myField;" + "    void m(int i) { myField = i; }"
				+ "}"), Program.fromClasses("class A {" + "    int myField;"
				+ "    void m(int i) { m(this, i); }"
				+ "    static void m(A a, int i) {" + "      a.myField = i;"
				+ "    }" + "}"));
	}
	...
	public void test21() {
		testSucc("A", "m()",
				Program.fromClasses("class A {" + "    public void m() {"
						+ "        this.m();" + "    }" + "}"),
				Program.fromClasses("class A {"
						+ "    public void m() { m(this); }"
						+ "    public static void m(A a) {" + "      a.m();"
						+ "    }" + "}"));
	}
	...
	public void test22() {
		testSucc("A", "m()", Program.fromClasses("class A {"
				...
				Program.fromClasses("class A {"
						...
						+ "        void f() {" + "            m();"
						+ "        }" + "    }"
						+ "    public static void m(A a) {" + "      a.n();"
						+ "    }" + "}"));
	}

	public void test23() {
		testSucc("A", "m(java.lang.Object)", Program.fromClasses("class A<T> {"
