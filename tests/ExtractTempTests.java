...
public class ExtractTempTests extends TestCase {
	...
	public void test3() {
		testFail(Program.fromBodyDecls("void m() {"
				+ "  System.out.println(n()+\" \"+((n())));" + "}",
				"int x = 42;", "int n() {" + "  return ++x;" + "}"));
	}

	public void test4() {
		testFail(Program.fromBodyDecls("int y = 42;",
				"void m() { System.out.println(y++ + \" \" + ((y))); }"));
	}

	public void test5() {
		testFail(Program.fromStmts("int y = 42;",
				"System.out.println(y++ + \" \" + ((y)));"));
	}

	public void test6() {
		testFail(Program.fromStmts("int y = 23;",
	...
	public void test8() {
		testSucc(
				Program.fromStmts("int f = 10;", "int h = 13;",
						"System.out.println(\" \" + f + ((h=12)));"),
				Program.fromStmts("int f = 10;", "int h = 13;",
						"int x = h = 12;", "System.out.println(\" \" + f + x);"));
	}

	public void test9() {
		testSucc(Program.fromStmts("int f = 10;", "int h = 13;",
				"System.out.println(\" \" + f++ + ((h=12)));"),
				Program.fromStmts("int f = 10;", "int h = 13;",
						"int x = h = 12;",
	...
	public void test10() {
		...
		testFail(Program.fromStmts("int f = 10;", "int g = 12;",
	...
	public void test11() {
		...
		testSucc(
				...
				Program.fromStmts("int g = 12;", "int x = g = 14;",
	...
	public void test13() {
		...
		testFail(Program.fromBodyDecls("int g = 12;",
				"class A { public int m() { return 3; } }", "A a = new A();",
