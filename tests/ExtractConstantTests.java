...
public class ExtractConstantTests extends TestCase {
	...
	public void test1() {
		testSucc(Program.fromBodyDecls("int m() {" + "  return ((23));" + "}"),
				Program.fromBodyDecls("int m() {" + "  return C;" + "}",
						"private static final int C = 23;"));
	}

	public void test2() {
		testSucc(Program.fromBodyDecls("int m() {" + "  return ((f()));" + "}",
	...
	public void test3() {
		testFail(Program.fromBodyDecls("int m() {" + "  return ((f()));" + "}",
				"int f() {" + "  return 23;" + "}"));
	}

	public void test4() {
		testFail(Program.fromBodyDecls("Object m() {" + "  return ((null));"
				+ "}"));
	}
}