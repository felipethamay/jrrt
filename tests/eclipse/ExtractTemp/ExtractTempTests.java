...
public class ExtractTempTests extends TestCase {
	...
	public static Expr findExpr(ASTNode p, int startLine, int startColumn,
		...
		for (int i = 0; i < p.getNumChild(); ++i) {
			Expr res = findExpr(p.getChild(i), startLine, startColumn, endLine,
					endColumn);
			if (res != null)
				return res;
		}
		if (p instanceof AbstractDot) {
			...
			if (pdot.getRight() instanceof AbstractDot) {
				...
				pdot.setLeft(l2);
				pdot.setRight(rr);
				Expr res = findExpr(p, startLine, startColumn, endLine,
						endColumn);
				if (res != null)
					return res;
				pdot.setLeft(l);
	...
	private void helper1(int startLine, int startColumn, int endLine,
			...
			String tempName, String guessedTempName) {
	...
	private void warningHelper1(int startLine, int startColumn, int endLine,
			int endColumn, boolean replaceAll, boolean makeFinal,
			String tempName, String guessedTempName) {
		helper1(startLine, startColumn, endLine, endColumn, replaceAll,
				makeFinal, tempName, guessedTempName);
	}
	...
	/*
	 * public void test5() throws Exception{ helper1(4, 16, 4, 21, true, false,
	 * "temp", "j"); }
	 */

	// disabled: clone detection
	/*
	 * public void test6() throws Exception{ helper1(4, 16, 4, 21, true, true,
	 * "temp", "j"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test8() throws Exception{ helper1(5, 20, 5, 25, true, false,
	 * "temp", "j"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test10() throws Exception{ helper1(5, 20, 5, 25, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test11() throws Exception{ helper1(5, 20, 5, 25, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test12() throws Exception{ helper1(5, 17, 5, 22, true, false,
	 * "temp", "i"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test17() throws Exception{ helper1(5, 20, 5, 25, true, false,
	 * "temp", "j"); }
	 */

	// disabled: clone detection
	/*
	 * public void test18() throws Exception{ helper1(6, 20, 6, 25, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test19() throws Exception{ helper1(5, 20, 5, 23, true, false,
	 * "temp", "f"); }
	 */
	...
	/*
	 * public void test23() throws Exception{ helper1(7, 17, 7, 20, false,
	 * false, "temp", "b"); }
	 */

	// disabled: clone detection
	/*
	 * public void test25() throws Exception{ helper1(4, 17, 4, 22, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test26() throws Exception{ helper1(5, 19, 5, 23, true, false,
	 * "temp", "i"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test39() throws Exception{ helper1(4, 14, 4, 26, true, false,
	 * "temp", "object"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test46() throws Exception{ helper1(4, 9, 4, 12, true, false,
	 * "temp", "f"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test51() throws Exception{ helper1(5, 15, 5, 18, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test52() throws Exception{ helper1(15, 47, 15, 60, true,
	 * false, "valueOnIndexI", "object"); }
	 */

	// disabled: clone detection
	/*
	 * public void test53() throws Exception{ helper1(6, 17, 6, 22, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test54() throws Exception{ helper1(6, 37, 6, 43, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test55() throws Exception{ helper1(6, 19, 6, 24, true, false,
	 * "temp", "i"); }
	 */

	// disabled: clone detection
	/*
	 * public void test56() throws Exception{ helper1(6, 24, 6, 29, true, false,
	 * "temp", "i"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test62() throws Exception{ helper1(10, 17, 10, 28, true,
	 * false, "temp", "string"); }
	 */

	// disabled: clone detection
	/*
	 * public void test63() throws Exception{ helper1(9, 20, 9, 23, true, false,
	 * "temp", "string"); }
	 */

	// disabled: clone detection
	/*
	 * public void test64() throws Exception{ helper1(10, 17, 10, 28, true,
	 * false, "temp", "string"); }
	 */
	...
	// disabled: conservative dataflow
	/*
	 * public void test70() throws Exception{ helper1(7, 28, 7, 42, true, true,
	 * "temp", "length"); }
	 */
	...
	// disabled: conservative dataflow
	/*
	 * public void test73() throws Exception{ warningHelper1(6, 39, 6, 40, true,
	 * false, "temp", "i2"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test78() throws Exception { helper1(5, 21, 5, 27, true,
	 * false, "o2", "o"); }
	 */
	...
	/*
	 * disabled: does not compile public void test89() throws Exception{
	...
	// disabled: clone detection
	/*
	 * public void test92() throws Exception { helper1(9, 32, 9, 44, true,
	 * false, "asList", "asList"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test95() throws Exception { helper1(5, 23, 5, 33, true,
	 * false, "temp", "b"); }
	 */
	...
	// disabled: conservative dataflow
	/*
	 * public void test97() throws Exception { helper1(10, 32, 10, 47, true,
	 * false, "temp", "nextElement"); }
	 */

	// disabled: conservative dataflow
	/*
	 * public void test98() throws Exception { helper1(8, 32, 8, 44, true, true,
	 * "temp", "string"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void test100() throws Exception { helper1(5, 28, 5, 40, true,
	 * false, "temp", "object"); }
	 */
	...
	/*
	 * public void testFail19() throws Exception{ failHelper1(6, 16, 6, 18,
	 * false, false, "temp"); }
	 */
	...
	// disabled: clone detection
	/*
	 * public void testFail27() throws Exception{ failHelper1(7, 13, 7, 24,
	 * true, false, "temp"); }
	 */

	// disabled: clone detection
	/*
	 * public void testFail28() throws Exception{ failHelper1(7, 17, 7, 28,
	 * true, false, "temp"); }
	 */
