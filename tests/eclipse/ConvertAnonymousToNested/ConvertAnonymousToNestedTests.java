...
public class ConvertAnonymousToNestedTests extends TestCase {
	...
	private AnonymousDecl findAnonymous(ASTNode p, int startLine,
			int startColumn, int endLine, int endColumn) {
		if (p == null)
			return null;
		for (int i = 0; i < p.getNumChild(); ++i) {
			AnonymousDecl res = findAnonymous(p.getChild(i), startLine,
		...
		if (p instanceof AnonymousDecl) {
			...
			if ((pstartLine < startLine || pstartLine == startLine
					...
					&& (pendLine > endLine || pendLine == endLine
							&& pendColumn >= endColumn))
	...
	private void helper1(int startLine, int startColumn, int endLine,
			int endColumn, boolean makeFinal, String className,
		...
		assertNotNull(out);
		AnonymousDecl anon = findAnonymous(in, startLine, startColumn, endLine,
				endColumn);
		assertNotNull(anon);
		try {
	...
	private void helper1(int startLine, int startColumn, int endLine,
			int endColumn, boolean makeFinal, boolean makeStatic,
			String className, boolean makePublic) throws Exception {
		Program in = CompileHelper.compile(getTestFileName(true, true));
		Program out = CompileHelper.compile(getTestFileName(true, false));
		assertNotNull(in);
		String originalProgram = in.toString();
	...
	private void failActivationHelper(int startLine, int startColumn,
	 ...
	 * printTestDisabledMessage("corner case - local types"); // failHelper1(6,
	 * 14, 6, 16, true, "Inner", Modifier.PRIVATE, RefactoringStatus.FATAL); }
	 */
	...
	public void test22() throws Exception {
		/*
		 * disabled: differing interpretation helper1(9, 34, 9, 34, true,
		 * "Inner", false);
		 */
	}
	...
	public void test23() throws Exception {
		/*
		 * disabled: differing interpretation helper1(6, 20, 6, 21, true,
		 * "Inner", false);
		 */
	}
	...
	public void test25() throws Exception {
		/*
		 * disabled: differing interpretation helper1(8, 28, 8, 28, true,
		 * "Inner", false);
		 */
	}
	...
	public void test27() throws Exception {
		/*
		 * disabled: differing interpretation helper1(11, 39, 11, 39, true,
		 * "Inner", false);
		 */
	}
	...
	public void test28() throws Exception {
		...
		/*
		 * disabled: differing interpretation helper1(10, 17, 10, 17, true,
		 * "Inner", false);
		 */
	}
	...
	/*
	 * disabled: does not compile public void test30() throws Exception{ // 2
	 * syntax errors helper1(5, 32, 5, 32, true, true, "Greeter", false); }
	 */
	...
	/*
	 * disabled: no support for making new type static public void
	 * testGenerics6() throws Exception{ helper1(7, 20, 7, 20, true, true,
	 * "Inner", false); }
	 */
	...
	/*
	 * disabled: JastAddJ bug public void test32() throws Exception{ // for bug
	 * 158028 helper1(10, 30, 10, 36, true, false, "Inner1Extension", false); }
	 */
}
