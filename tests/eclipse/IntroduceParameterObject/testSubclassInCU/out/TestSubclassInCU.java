...
class B extends TestSubclassInCU {
	public int foo(FooParameter parameterObject) {
		...
		// /foo(new FooParameter(parameterObject.xg, parameterObject.yg,
		// parameterObject.zg));
		// /this.foo(new FooParameter(parameterObject.xg, parameterObject.zg,
		// parameterObject.yg));
		// /new B().foo(new FooParameter(parameterObject.xg, parameterObject.zg,
		// parameterObject.yg));
		// /super.foo(new FooParameter(parameterObject.xg, parameterObject.zg,
		// parameterObject.yg));
		// /return super.x;
