...
public class RenameStaticMethodTests extends TestCase {
	...
	private void helper1_0(String methodName, String newMethodName,
		...
		Program in = CompileHelper
				.compileAllJavaFilesUnder("tests/eclipse/RenameStaticMethod/"
						+ getName() + "/in");
		assertNotNull(in);
	...
	private void helper2_0(String methodName, String newMethodName,
			String[] signatures, boolean updateReferences,
	...
	/*
	 * disabled: tests idiosyncratic feature public void test9() throws
	 * Exception{ helper2_0("m", "k", new String[]{Signature.SIG_INT}, false,
	 * false); }
	 */
	...
	/*
	 * disabled: we can do this public void testStaticImportFail0() throws
	 * Exception { helper1(); }
	 */
	...
	/*
	 * disabled: JastAddJ bug public void testStaticImport3() throws Exception {
	 * helper2(); }
	 */
	...
	/*
	 * disabled: JastAddJ bug public void testStaticImport5() throws Exception {
	 * helper2(); }
	 */

	/*
	 * disabled: unsupported feature public void testDelegate01() throws
	 * Exception { // simple static delegate helperDelegate(); }
	 */
