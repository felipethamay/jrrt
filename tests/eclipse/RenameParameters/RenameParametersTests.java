...
public class RenameParametersTests extends TestCase {
	...
	// ------------
	private void helper1(String[] newNames, String[] signature)
			throws Exception {
	...
	private void helper2(String[] newNames, String[] signature)
			throws Exception {
	...
	/*
	 * disabled: tests idiosyncratic feature public void test15() throws
	 * Exception{ helper1(new String[]{"j", "i"}, new String[]{"I", "I"}); }
	 */
	...
	/*
	 * disabled: tests idiosyncratic feature public void test17() throws
	 * Exception{ helper1(new String[]{"j", "i", "k"}, new String[]{"I", "I",
	 * "I"}); }
	 */
	...
	/*
	 * disabled: test idiosyncratic feature public void test23() throws
	 * Exception{ helper1(new String[]{"j", "i"}, new String[]{"I", "I"}); }
	 */
	...
	/*
	 * disabled: by Eclipse public void test32() throws Exception{
	 * printTestDisabledMessage("must do - constructor params"); }
	 */

	/*
	 * disabled: by Eclipse public void test33() throws Exception{
	...
	/*
	 * disabled: we can do this public void testFail1() throws Exception{
	 ...
	 * ("waiting for better conflict detection story from DB"); helper2(new
	...
	/*
	 * disabled: by Eclipse public void testFail21() throws Exception{
	 * printTestDisabledMessage
	 * ("Disabled since 1.4 compliance level doesn't produce error message"); //
	 * helper2(new String[]{"j"}, new String[]{"I"}); }
	 */
