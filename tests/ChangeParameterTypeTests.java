...
public class ChangeParameterTypeTests extends TestCase {
	private void testSucc(MethodDecl md, int idx, TypeDecl type, Program in,
			Program out) {
		assertNotNull(in);
		assertNotNull(out);
		assertNotNull(md);
	...
	private void testSucc(String methname, int idx, String typename,
	...
	private void testSucc(String hosttypename, String methname, int idx,
			String typename, Program in, Program out) {
		assertNotNull(in);
		TypeDecl host = in.findType(hosttypename);
		assertNotNull(host);
		MethodDecl md = null;
		if (methname.contains("("))
			md = (MethodDecl) host.localMethodsSignature(methname).iterator()
					.next();
		else
	...
	private void testFail(String hosttypename, String methname, int idx,
			String typename, Program in) {
		assertNotNull(in);
		TypeDecl host = in.findType(hosttypename);
		assertNotNull(host);
		MethodDecl md = null;
	...
	public void test2() {
		testSucc("A", "m", 0, "java.lang.Object", Program.fromClasses(
				"class A { void m(A a) { } }",
				"class B extends A { void m(A a) { } }"), Program.fromClasses(
				"class A { void m(Object a) { } }",
				"class B extends A { void m(Object a) { } }"));
	}

	public void test3() {
		testSucc("B", "m", 0, "java.lang.Object", Program.fromClasses(
				"class A { void m(A a) { } }",
				"class B extends A { void m(A a) { } }"), Program.fromClasses(
				"class A { void m(Object a) { } }",
				"class B extends A { void m(Object a) { } }"));
	...
	public void test6() {
		testSucc("A", "m(A)", 0, "java.lang.Object", Program.fromClasses(
				"class Super { void m(Object o) { } }",
				"class A extends Super { void m(A a) { } }"),
				Program.fromClasses(
						"class Super { private void m(Object o) { } }",
						"class A extends Super { void m(Object a) { } }"));
	}

	private final Program example = Program.fromClasses("class A {"
			+ "	public static void main(String[] args) {"
			+ "		Outer.C c = new Outer.C();"
			+ "		System.out.println(c.zip() + c.zap());" + "	}" + "}",
			"interface I {" + "	int foo(Outer.C x);" + "}", "class Outer {"
	...
	public void test10() {
		testSucc("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A {" + "  B b;" + "  void m(A a) {"
						+ "    b.n(a);" + "  }" + "}" + "class B {"
						+ "  void n(A a) { }" + "}"),
				Program.fromClasses("class A {" + "  B b;"
						+ "  void m(Object a) {" + "    b.n(a);" + "  }" + "}"
						+ "class B {" + "  void n(Object a) { }" + "}"));
	}

	public void test11() {
		testSucc("Super", "m", 0, "java.lang.Object", Program.fromClasses(
				"class Super {" + "  public void m(String s) { }" + "}",
				"interface I {" + "  void m(String s);" + "}",
				"class A extends Super implements I { }"), Program.fromClasses(
				"class Super {" + "  public void m(Object s) { }" + "}",
	...
	public void test12() {
		testFail("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A {" + "  void m(String s) {"
						+ "    String[] ss = { s };" + "  }" + "}"));
	}
	...
	public void test13() {
		testSucc("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A {" + "  void m(String s) {"
						...
						+ "  { n(null, \"\"); }" + "}"),
				Program.fromClasses("class A {" + "  void m(Object s) {"
						+ "    n(s, \"\");" + "  }"
	...
	public void test14() {
		testSucc("A", "m", 0, "java.lang.Object", Program.fromClasses(
				"class A {" + "  void m(String s) {" + "    new B(s, \"\");"
						+ "  }" + "  { new B(null, \"\"); }" + "}", "class B {"
	...
	public void test16() {
		testFail("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A {" + "  String m(String s) {"
						+ "    return s;" + "  }" + "}" + "class B {"
						+ "  String s;" + "  void f(A a) {"
						+ "    s = a.m(null);" + "  }" + "}")/*
															 * ,
	...
	public void test17() {
		testFail("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A {" + "  String[] ss;"
						+ "  void m(String s) {" + "    ss = new String[1];"
						+ "    ss[0] = s;" + "  }" + "}"));
	}

	public void test18() {
		testSucc("C", "m", 0, "java.lang.Object", Program.fromClasses(
				"interface I { }", "class A implements I { A(I i) { } }",
				"class B { B(I i) { new A(i); } }",
				"class C { void m(A a) { new B(a); } }"), Program.fromClasses(
				"interface I { }", "class A implements I { A(Object i) { } }",
				"class B { B(Object i) { new A(i); } }",
				"class C { void m(Object a) { new B(a); } }"));
	}

	public void test19() {
		testFail("A", "m", 0, "B", Program.fromClasses("class A {"
				+ "  void m(C c) {" + "    c.n();" + "  }" + "}", "class B {"
				+ "  void n() throws Exception { }" + "}"
				+ "class C extends B {" + "  void n() { }" + "}"));
	}

	public void test20() {
		testFail("A", "m", 0, "java.lang.Throwable", Program.fromClasses(
	...
	public void test22() {
		testFail(
				...
				0,
				"java.lang.Number",
				Program.fromClasses("class A { void m(java.lang.Integer i){int j = 1 + i;} }"));
	}
	...
	public void test23() {
		testFail(
				...
				0,
				"java.lang.Object",
				Program.fromClasses("class A { void m(Boolean b){if(b){b = false;}else{}} }"));
	}
	...
	public void test24() {
		testFail(
				...
				0,
				"java.lang.Object",
				Program.fromClasses("class A { void m(Boolean b){ b = (b==true) ? false : true; }}"));
	}

	public void test25() {
		testFail("A", "m", 0, "java.lang.Object",
				Program.fromClasses("class A { void m(Integer i){ i++; }}"));
	}
	...
	public void test26() {
		testSucc(
				...
				0,
				"java.lang.Object",
				Program.fromClasses("class A { void m(Integer i){ System.out.print(i == null);}}"),
				Program.fromClasses("class A { void m(Object i){ System.out.print(i == null);}}"));
	}
	...
	public void test28() {
		testFail("B", "l", 0, "J", Program.fromClasses("class X {}",
				"class Y extends X {}", "interface I {X m(X x);}",
				"interface J {Y n(Y y);}", "class A implements I, J {"
						+ "  public X m(X x) {return null;}"
						+ "  public Y n(Y y) {return null;}" + "}", "class B {"
						+ "  void k(I i) {i = new A();}"
						+ "  void l(A a) {k(a);}" + "  I ii;"
						+ "  void m() {k(ii);}" + "}"));
	}
	...
	public void test31() {
		testFail("A", "m", 0, "java.lang.Object",
				Program.fromClasses("enum E { E1, E2 };", "class A {"
						+ "  int m(E e) {" + "    switch(e) {"
						+ "    case E1: return 23;" + "    default: return 42;"
						+ "    }" + "  }" + "}"));
	}
	...
	public void test33() {
		testSucc("I", "m", 0, "java.lang.Object", Program.fromClasses(
				"class A {public void m(String s){}}",
				"class B extends A implements I {}",
				"interface I {void m(String s);}"), Program.fromClasses(
		...
		testSucc(
				...
				Program.fromClasses(
						...
						"class X {"
								...
								+ "  }" + "}", "class Outer {"
								+ "  static class B { }"
								+ "  class Inner extends X {" + "    B f;"
								+ "  }" + "}"),
				Program.fromClasses("interface I { void foo(X.B p); }",
						"class X {"
