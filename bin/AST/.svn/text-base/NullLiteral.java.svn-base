 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/Literals.ast:28
 */
public class NullLiteral extends Literal implements Cloneable {
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/TypeAnalysis.jrag:307
   */
  @SuppressWarnings({"unchecked", "cast"})
