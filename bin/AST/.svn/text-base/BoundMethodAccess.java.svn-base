 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/BoundNames.ast:3
 */
public class BoundMethodAccess extends MethodAccess implements Cloneable {
   ...
   * @ast method 
   * @aspect BoundNames
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/BoundNames.jrag:61
   */
   ...
   * @ast method 
   * @aspect BoundNames
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/BoundNames.jrag:65
   */
   ...
   * 
   */
  public void refined__BoundMethodAccess_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:69
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__BoundMethodAccess_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__BoundMethodAccess_setID(value);
				}
			});
		}
		refined__BoundMethodAccess_setID(value);
   ...
   * @attribute syn
   * @aspect BoundNames
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.4Frontend/BoundNames.jrag:66
   */
  @SuppressWarnings({"unchecked", "cast"})
