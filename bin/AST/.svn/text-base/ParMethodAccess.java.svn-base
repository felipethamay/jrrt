 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.ast:13
 */
public class ParMethodAccess extends MethodAccess implements Cloneable {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:11
   */
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:179
   */
   ...
   * 
   */
  public void refined__ParMethodAccess_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:91
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ParMethodAccess_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ParMethodAccess_setID(value);
				}
			});
		}
		refined__ParMethodAccess_setID(value);
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/MethodSignature.jrag:311
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/LanguageExtensions/BareParMethodAccess.jrag:2
   */
  public boolean isBare() {
    ASTNode$State state = state();
    try {  return !isQualified();  }
    finally {
    }
  }
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:142
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:143
   * @apilevel internal
   */
