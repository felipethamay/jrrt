 ...
 * @ast node
 * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.ast:17
 */
public class ParSuperConstructorAccess extends SuperConstructorAccess implements Cloneable {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:197
   */
   ...
   * 
   */
  public void refined__ParSuperConstructorAccess_setID(String value) {
   ...
   * @declaredat /Users/melmongiovi/Documents/workspace6/jrrt_newversion/undo/UndoSettersAutogenerated.jrag:157
   */
   public void setID(final String value) {
		if (Program.isRecordingASTChanges()) {
			Program.addUndoAction(new ASTModificationReplaceEdit(this.isInTree(), this, IDstart, IDend, tokenString_ID, value) {
				@Override
				public void undo() {
					refined__ParSuperConstructorAccess_setID(oldValue);
				}
				@Override
				...
				public void redo() {
					...
					refined__ParSuperConstructorAccess_setID(value);
				}
			});
		}
		refined__ParSuperConstructorAccess_setID(value);
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:158
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /Users/melmongiovi/Documents/workspace6/Java1.5Frontend/GenericMethods.jrag:159
   * @apilevel internal
   */
