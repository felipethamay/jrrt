...
import tests.jdolly.SafeRefactorLogger;
import tests.jdolly.TestLogger;
import AST.Program;
import AST.RawCU;
import AST.RefactoringException;
import br.edu.dsc.ufcg.alloygen.runners.FileUtil;
import br.edu.dsc.ufcg.jdolly.JDolly;

public abstract class Test_oldTech {
...
//	
//		try {
//			os.count("/home/spg-experiment-3/Documents/jrrt/"+refactoring+"/skip"+skip+"/jrrt_sri_message_"+refactoring+"_"+skip+".txt");
...
//				break;
//			if ((i % 1000) == 0) {
//				FileUtil.gravaArquivo(logger.getLogDir().toString() + "/SAFIRA_RESULTS"+i,
//						safiraResults.toString());
//				FileUtil.gravaArquivo(logger.getLogDir().toString() + "/SR_RESULTS"+i,
//						srResults.toString());
////				FileUtil.gravaArquivo(logger.getLogDir().toString() + "/SR_RESULTS2"+i,
////						srResults2.toString());
//			}
//				continue;
...
//					else {
//						SRImpact sri;
//						sri = new SRImpact("",logger.getTestDirectory().getAbsolutePath().toString()+"/in/" , logger.getTestDirectory().getAbsolutePath().toString()+"/out/jrrt/", "","0.3", "", true);
...
//							sb.append(Conditions.getlog()+" subjetc OS"+generatedPrograms+" skip25"+(i/skip)+" dir"+dir+"\n");
//						}
//					}
...
//		System.out.println("Fracao:" + fraction);
		...
		String fileLog = "/home/spg-experiment-3/Documents/OS/jrrt/"+refactoringName+"/"+"jrrt_skip"+skip+".txt";
		FileUtil.gravaArquivo(fileLog, " total time: "+( (double )tempo/60/60) + "h  = "+tempo+"s  Generated programs: "+generatedPrograms+ " "+ sb.toString());
//		}
	}
...
//
	...
	public abstract Program refactoring(Program program)
...
//	public List<Object> checkBehaviorConditions(String in, String out, StringBuffer b, String timeLimit, int counter) throws Exception {
//		
...
//	}
//
//	public boolean checkBehaviorConditions2(String in, String out) throws Exception {
//
//		FileUtil.createFolders();
//		File buildFile = new File("ant" + Constants.FILE_SEPARATOR
//				+ "build_run.xml");
